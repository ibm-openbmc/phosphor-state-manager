...
class MockServices : public testing::NiceMock<Services>
{
  public:
    ...
    MOCK_METHOD(bool, getProvisioned, (), (const, override));
    ...
    void setupDefaultBehavior()
    {
        ...
        ON_CALL(*this, getPersistentDataPath())
            .WillByDefault(Return("/tmp/test_data"));
        ...
        ON_CALL(*this, waitForPeerConnection()).WillByDefault([]() {
            return test_helpers::makeCompletedTask();
        });
